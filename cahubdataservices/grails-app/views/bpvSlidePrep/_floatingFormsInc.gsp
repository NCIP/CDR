...
<div id="add-slide">
    <g:formRemote name="slide" url="[controller: 'bpvSlidePrep', action: 'addSlide']" update="slideDialog">
        ...
        <table>
            <tbody>
                ...
                <tr class="prop">
                    ...
                    <g:select name="module" id="newmodule" from="${[Module.findByCode('MODULE1'),Module.findByCode('MODULE2'), Module.findByCode('MODULE3N'), Module.findByCode('MODULE4N')] }" optionKey="id" value=""  noSelection="['': '']" /></td>
                        </g:if>
                   <g:else>
                     <g:select name="module" id="newmodule" from="${[Module.findByCode('MODULE1'),Module.findByCode('MODULE2'), Module.findByCode('MODULE5')] }" optionKey="id" value=""  noSelection="['': '']" /></td>
                   </g:else>
