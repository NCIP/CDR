...
<g:set var="bodyclass" value="prcreport editbms wide" scope="request"/>
<html>
    <head>
    ...
    <body>
      ...
      <div id="container" class="clearfix">
            ...
            <g:form method="post" enctype="multipart/form-data" >
                ...
                <g:each in="${prcSpecimenMap}" var="psmap">
                  <g:each in="${psmap.value}" status="i" var="ps">
                ...
                <g:each in="${prcIssueList}" status="i" var="pi">
                 ...
                 <g:each in="${prcAttachmentList}" status="i" var="pa">
                  ...
                  <g:if test="${serologyList}">
                     <br></br>
                     <div align="center">   
                   <table align="Center" style="width:400px; border: 1px solid #336699 " >
                     <g:each in="${serologyList}" status="i" var="se">
                       <g:if test="${i==0}">
                             <tr><td style=" border-left: 1px solid #336699 "><font color ="red"><b>Serology Alert:</b></font> </td><td><font color ="red"><b>${se}</b></font></td></tr>
                       </g:if>
                       <g:else>
                           <tr><td style="border-left: 1px solid #336699 ">&nbsp; </td><td ><font color ="red"><b>${se}</b></font></td></tr>
                       </g:else>
                     </g:each>
                  </table>
                     </div> 
                  ...
                  <g:each in="${prcSpecimenMap}" var="psmap">
                    <h3>Specimens (Tissue Type: ${psmap.key})</h3>
                  ...
                  <g:if test="${prcReportInstance.caseRecord.parentCase.prcReport}">
                  ...
                  <g:each in="${psmap.value}" status="i" var="ps">
                      ...
                      <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                        ...
                        <td rowspan="${ps.specimenRecord.slides?.size() == 0 ? 1 : ps.specimenRecord.slides?.size()}"  nowrap="nowrap">${ps.specimenRecord.specimenId} 
                          ...
                          <td rowspan="${ps.specimenRecord.slides?.size() == 0 ? 1 : ps.specimenRecord.slides?.size()}"  nowrap="nowrap">${ps.specimenRecord.fixative.name} </td>
                          <td rowspan="${ps.specimenRecord.slides?.size() == 0 ? 1 : ps.specimenRecord.slides?.size()}"  nowrap="nowrap">${ps.specimenRecord.protocol.delayHour} </td>
                        ...
                        <td  style="border-right: 1px solid #ccc" class="value ${errorMap.get(ps.id +'_inventoryStatus')}" rowspan="${ps.specimenRecord.slides?.size() == 0 ? 1 : ps.specimenRecord.slides?.size()}">
                            ...
                            <g:select name="${ps.id}_inventoryStatus" from="${nci.obbr.cahub.staticmembers.InventoryStatus.list(sort:'id')}" optionKey="name" value="${ps?.inventoryStatus?.name}"  noSelection="['': '']" />
                        ...
                        <table style="width:700px">
                           <tr class="prop" bgcolor="#FFFFCC">
                             ...
                             <tr class="prop" bgcolor="#FFFFCC">
                                ...
                                <td class="value" valign="top" style="border: 0px">
