                                <g:if test="${bpvLocalPathReviewInstance?.category=='Ovary'}">
                                    <tr class="prop">
                                        ...
                                        <td class="value ${errorMap.get('pathNodes')}" >
                                            <div>
                                ...
                                <g:if test="${bpvLocalPathReviewInstance?.category=='Ovary'}">
                                    <tr class="prop">
                                        ...
                                        <td class="value ${errorMap.get('pathMetastases')}" >
                                            <div>
                                ...
                                <g:if test="${bpvLocalPathReviewInstance?.category=='Ovary'}">
                                    <tr class="prop">
                                        ...
                                        <td class="value ${errorMap.get('pathStage')}" >
                                            <div>
                                ...
                                <tr class="prop">
                                    <td class="name" colspan="2">
                                        <g:if test="${bpvLocalPathReviewInstance?.meetsCriteria == 'No'}">
                                            <span class="subentry value ${errorMap.get('reasonNotMeet')}" id="f" style="display:display">Specify findings: <br/><g:textArea class="textwide" name="reasonNotMeet" cols="40" rows="5" value="${bpvLocalPathReviewInstance?.reasonNotMeet}" id="re" /></span>
                                        </g:if>
                                        <g:else>
                                ...
                                <tr class="prop">
                                    <td class="name" colspan="2">
                                        <g:if test="${bpvLocalPathReviewInstance?.consistentLocalPrc == 'No'}">
                                            <span class="subentry value ${errorMap.get('reasonNotCons')}" id="f2" style="display:display">Specify findings: <br/><g:textArea class="textwide" name="reasonNotCons" cols="40" rows="5" value="${bpvLocalPathReviewInstance?.reasonNotCons}" id="re2" /></span>
                                        </g:if>
                                        <g:else>
                                ...
                                <tr class="prop">
                                    ...
                                    <td class="value ${errorMap.get('pathologistName')}" > 
                                ...
                                <tr class="prop">
                                    ...
                                    <td class="value ${errorMap.get('dateSlideReview')}" > 
                                ...
                                <tr class="prop">
                                    ...
                                    <td class="value ${errorMap.get('dataEnteredBy')}" > 
