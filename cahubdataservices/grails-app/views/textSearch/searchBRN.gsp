...
<body>
    ...
    <g:else>
      ...
      <div class="list">
        <g:render template="/caseRecord/caseRecordBrnTable_tmpl" bean="${candidateRecordInstanceList}" />              
      </div>
      <g:if test="${total > size}">
        <div class="paginateButtons">
          <g:paginate total="${total}" params="[query:query]" controller="textSearch" action="searchBRN" max="25" /> | Total: ${total}
        </div>
      </g:if>
    </g:else>
  </div>
