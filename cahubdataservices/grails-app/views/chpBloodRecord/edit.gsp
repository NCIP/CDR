...
<g:set var="bodyclass" value="chpblood edit" scope="request"/>
<html>
    <head>
    ...
    <body>
      ...
      <div id="container" class="clearfix">
            ...
            <g:form method="post" >
                <g:hiddenField name="id" value="${chpBloodRecordInstance?.id}" />
                <g:hiddenField name="version" value="${chpBloodRecordInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
