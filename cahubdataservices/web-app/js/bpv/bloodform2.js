...
var availableTissueTypes = ["Main","DNA","RNA","Plasma","wholeBlood"];
var tabsListStr = "";
...
bpvErrorDict[ "bpvErr25"] = "<a href = \"#plasmaProcSopDev_yes\" class=\"tabs-plasma\" title=\"Go to this question\">Please select an option for the question about Plasma SOP deviation</a>";
...
bpvErrorDict[ "bpvErr72"] = "<a href = \"#ParentTubes\" class=\"tabs-main\" title=\"Go to this question\">Please add the required Plasma EDTA tube</a>";
bpvErrorDict[ "bpvErr73"] = "<a href = \"#wholeBloodProcFrozen\" class=\"tabs-wholeblood\" title=\"Go to this question\">Time Whole Cell aliquots were frozen cannot precede the Date and Time blood was received in the lab</a>";
bpvErrorDict[ "bpvErr74"] = "<a href = \"#wholeBloodProcFrozen\" class=\"tabs-wholeblood\" title=\"Go to this question\">Time Whole Cell aliquots were frozen cannot be in the future</a>";
bpvErrorDict[ "bpvErr75"] = "<a href = \"#wholeBloodProcStorage\" class=\"tabs-wholeblood\" title=\"Go to this question\">Time Whole Cell aliquots were transferred to storage cannot precede the Date and Time blood was received in the lab</a>";
bpvErrorDict[ "bpvErr76"] = "<a href = \"#wholeBloodProcStorage\" class=\"tabs-wholeblood\" title=\"Go to this question\">Time Whole Cell aliquots were transferred to storage cannot be in the future</a>";
bpvErrorDict[ "bpvErr77"] = "<a href = \"#wholeBloodProcSopDev_yes\" class=\"tabs-wholeblood\" title=\"Go to this question\">Please select an option for question #41</a>";
bpvErrorDict[ "bpvErr78"] = "<a href = \"#wholeBloodProcComments\" class=\"tabs-wholeblood\" title=\"Go to this question\">Whole Cell processing comments is required</a>";
bpvErrorDict[ "bpvErr79"] = "<a href = \"#WcpTubes\" class=\"tabs-wholeblood\" title=\"Go to this question\">A minimum of 3 Whole Cell Pellet aliquots for the chosen EDTA tube are required</a>";
bpvErrorDict[ "bpvErr80"] = "<a href = \"#plasmaParBarCodeSelect\" class=\"tabs-plasma\" title=\"Go to this question\">Please select a plasma specimen barcode ID for #26</a>";
bpvErrorDict[ "bpvErr81"] = "<a href = \"#PlasmaTubes\" class=\"tabs-plasma\" title=\"Go to this question\">A minimum of 3 aliquots transferred to -80°C Freezer are required</a>";
bpvErrorDict[ "bpvErr82"] = "<a href = \"#PlasmaTubes\" class=\"tabs-plasma\" title=\"Go to this question\">A minimum of 3 aliquots transferred to LN Freezer are required</a>";
bpvErrorDict[ "bpvErr83"] = "<a href = \"#PlasmaTubes\" class=\"tabs-plasma\" title=\"Go to this question\">Number of aliquots transferred to -80°C Freezer cannot be more than 3</a>";
bpvErrorDict[ "bpvErr84"] = "<a href = \"#bloodReceiptTech\" class=\"tabs-main\" title=\"Go to this question\">Name of Person who received Blood tube(s) in lab is required</a>";
bpvErrorDict[ "bpvErr85"] = "<a href = \"#bloodReceiptTech2\" class=\"tabs-main\" title=\"Go to this question\">Name of Person who received Blood tube(s) in lab for the second draw is required</a>";
bpvErrorDict[ "bpvErr86"] = "<a href = \"#plasmaProcStart\" class=\"tabs-plasma\" title=\"Go to this question\">Time Plasma processing began is required</a>";
bpvErrorDict[ "bpvErr87"] = "<a href = \"#plasmaProcTech\" class=\"tabs-plasma\" title=\"Go to this question\">Name of Person who processed the Plasma aliquots is required</a>";
bpvErrorDict[ "bpvErr88"] = "<a href = \"#plasmaTransferTech\" class=\"tabs-plasma\" title=\"Go to this question\">Name of Person who transferred the Plasma aliquots to storage is required</a>";
bpvErrorDict[ "bpvErr89"] = "<a href = \"#plasmaHemolysis\" class=\"tabs-plasma\" title=\"Go to this question\">Please select an option for the question (#34) about Gross Hemolysis</a>";
bpvErrorDict[ "bpvErr90"] = "<a href = \"#wholeBloodProcFrozen\" class=\"tabs-wholeblood\" title=\"Go to this question\">Time Whole Cell aliquots were frozen is required</a>";
bpvErrorDict[ "bpvErr91"] = "<a href = \"#wholeBloodProcStorage\" class=\"tabs-wholeblood\" title=\"Go to this question\">Time Whole Cell aliquots were transferred to storage is required</a>";
bpvErrorDict[ "bpvErr92"] = "<a href = \"#wholeBloodProcEnd\" class=\"tabs-wholeblood\" title=\"Go to this question\">Time Whole Cell Pellet Aliquots processing was completed cannot precede the Date and Time blood was received in the lab</a>";
bpvErrorDict[ "bpvErr93"] = "<a href = \"#wholeBloodProcEnd\" class=\"tabs-wholeblood\" title=\"Go to this question\">Time Whole Cell Pellet Aliquots processing was completed cannot be in the future</a>";
bpvErrorDict[ "bpvErr94"] = "<a href = \"#wholeBloodProcEnd\" class=\"tabs-wholeblood\" title=\"Go to this question\">Time Whole Cell Pellet Aliquots processing was completed is required</a>";
bpvErrorDict[ "bpvErr95"] = "<a href = \"#plasmaRemainingVol\" class=\"tabs-wholeblood\" title=\"Go to this question\">Volume of the Whole Cell Pellet remaining after plasma removed is required</a>";
bpvErrorDict[ "bpvErr96"] = "<a href = \"#wholeBloodProcTech\" class=\"tabs-wholeblood\" title=\"Go to this question\">Name of Person who processed the Whole Cell Pellet Aliquots is required</a>";
...
$(document).ready(function(){
    ...
    $("#bloodMinimum_no").click(function() {
       if($("#proceedByLeidosSection").length == 0) { 
    ...
    $(".edit #bloodMinimum_yes").after(function() {
       if( $(this).attr("checked") || $("#proceedByLeidosSection").length != 0) { 
         $('#tabs-main tr.bottomsection').show(); 
         showhideOthDT(); 
         showhideOthNurse();
         showhideOthSource();
        ...
        buttons: {
            ...
            Cancel: function() {
                ...
                $("#" + currentSpecSelect + "ParBarCode").val(originalVal);
                 $("#serumParBarcodeDisp").html(originalVal);
                currentSpecSelect = "";
    ...
    $("#specimenIdPl").blur(function() {
        if($(this).val().length > 0) {
            $("#bloodFrozen").datepicker("setDate", new Date());
        }
    }); 

    $("#scannedIdPl").blur(function() {
        if($(this).val().length > 0) {
            if($(this).val() == $("#specimenIdPl").val()) {
                $("#bloodStorage").datepicker("setDate", new Date());
            }
        }
    }); 

    $("#scannedIdPlEd").blur(function() {
        if($(this).val().length > 0) {
            if($(this).val() == $("#specimenIdPlEd").val()) {
                $("#bloodStorageEd").datepicker("setDate", new Date());
            }
        }
    }); 
...
function setBloodTab( bTypeDom ) {
    ...
    if(bTypeDom!=null && bTypeDom.attr("id").replace("tabs-","") == "plasma" && $("#plasmaParBarCodeSelect").val().length == 0){
        $("#addPlasmaCTBtn").hide();
        $("#selectSpecIDFirst").show();
    } 
    if( bTypeDom != null){
...
function buildTabsOnTable(){  
    ...
    $(".tissueType").each(function() {
      ...
      if( currentTissue === "plasma" ) {
        plasmaCnt++;
      } else if( currentTissue === "dna" ) {
        dnaCnt++;
        $("#ctId").option("DNAPAX").remove();
      } else if( currentTissue === "rna" ) {
        rnaCnt++;
        $("#ctId").option("RNAPAX").remove();
      }
      ...
      var plasmaParBarCode = $("#plasmaParBarCode").val();
      if(plasmaParBarCode.length > 0){
          activeTissueTypes["wholeblood"]=1;
      }
    });
    ...
    if (tableRowCount > 0) {    
        ...
        for(var i=0; i < availableTissueTypes.length; i++){
           ...
           if(activeTissueTypes[currentTissue]!=undefined){
              ...
              tabsListStr += ("<li id=\"bloodform-tabs-" + currentTissue +"\"><a href=\"#tabs-" + currentTissue +"\" name=\"tabs-" + currentTissue +"\">" + availableTissueTypes[i].replace("wholeBlood","Whole Cell Pellet") +"</a></li>"); 
           } 
         }
...
function permissionToAllowParentsDel() {
    $("#ParentTubes tbody tr").each(function() { 
        if ( ($(this).hasClass("gen1") || $(this).hasClass("gen2"))) {
            if ($("."+$(this).attr("id")).length == 0) { 
                $("#"+$(this).attr("id") + " " + ".deleteOnly").css("visibility","visible");
            } else {
                $("#"+$(this).attr("id") + " " + ".deleteOnly").css("visibility","hidden");
            }
        }
    });
}
...
function addParentTableWithAliquot(aType, gen){
    if ($("#" + capitalize(aType) + "Tubes .errors").length === 0) {
        ...
        var plasmaParentLink = "";
        var lastParentRowClass;
        var lastParentRowStyle;

        //plasmaParentLink links to the correct plasma tube
        if(aType=="plasma" || aType=="wcp"){
            plasmaParBarCode = $("#plasmaParBarCode").val();
            plasmaIdsArr = $(".gen1-plasma .specimenIdName");
            for (var i=0; i < plasmaIdsArr.length; i++){
                if(plasmaIdsArr[i].innerHTML == plasmaParBarCode){
                    plasmaParentLink = "." + getParentByTagName(plasmaIdsArr[i],"tr").id;
                }
            }
        }
        
        aSiblingsCnt = $(plasmaParentLink  + '.gen' + gen + '-' + aType + '-parent').size();

        //grab the last type gen row in parent table
        if ( aSiblingsCnt > 0 ) {
            lastParentRow = $(plasmaParentLink  + '.gen' + gen + '-' + aType + '-parent').eq(aSiblingsCnt-1);
            lastParentRowClass = $(lastParentRow).attr("class");
            lastParentRowStyle = $(lastParentRow).attr("style");
        } else {
            aParentSiblingsCnt = $(plasmaParentLink  + '.gen' + (gen - 1) + '-' + aType + '-parent' ).size();
            if ( aParentSiblingsCnt > 0) {
                lastParentRow = $(plasmaParentLink  + '.gen' + (gen - 1) + '-' + aType + '-parent' ).eq(aParentSiblingsCnt-1);
        ...
        var rowHTML = '<tr id="' + addedRowID +'-parent" class="' + lastParentRowClass + '" style="' + lastParentRowStyle + '"><td></td><td class="ui-state-default"><span class="ui-icon ui-icon-arrowreturnthick-1-e"></span><span class="specimenIdAl">' + specimenIdAl + '</span></td><td>Cryovial</td><td class="tissueType">' + aType.replace("wcp","Whole Cell Pellet") + '</td><td class="volumeAl textcenter">' + volumeAl + ' ml</td><td class="textcenter editOnly">' + actionContent + '</td></tr>';
        $(rowHTML).insertAfter(lastParentRow);
...
function bloodformPopUps() { 
    ...
    $( "#addPlasmaBtn" ).button().click(function() {
            $( "#add-plasma .cleardate" ).trigger("click");
            $( "#add-plasma" ).dialog( "open" );
            $( "#specimenIdPl" ).val( "" );
            $( "#scannedIdPl" ).val( "" );
            $( "#freezerType" ).val( "" );
            $( "#volumePl" ).val( "0.0" );
            $( "#coniTbCd" ).val($("#conTbId").html());
    ...
    $( "#addWcpBtn" ).button().click(function() {
            $( "#add-wcp" ).dialog( "open" );
            $( "#specimenIdWcp" ).val( "" );
            $( "#volumeWcp" ).val( "0.0" );
            document.getElementById('wcpFrm1').parPlBarCd.value = document.getElementById('plasmaParBarCode').value
    ...
    $("#saveBtn2").click(function(){
        var firstEntryCleared = entryNotEmpty("specimenIdPl","Plasma Aliquot Specimen barcode ID") && volValid('volumePl') && dateValid("bloodFrozen","Time Placed on Dry Ice");
        var secondEntryCleared =  $.trim($("#scannedIdPl").val()).length == 0 || (mustMatch("specimenIdPl","scannedIdPl","The two barcode IDs must match") && entryNotEmpty("scannedIdPl","Scanned ID of Cryovial when transferred") && dateValid("bloodStorage","Time Transferred to Freezer") && dateOrder("bloodFrozen","Time Placed on Dry Ice","bloodStorage","Time Transferred to Freezer") && entryNotEmpty("freezerType","Freezer Type Transferred to"));
    ...
    $("#saveBtn5").click(function(){
        var firstEntryCleared = volValid('volumePlEd');
        var secondEntryCleared =  $.trim($("#scannedIdPlEd").val()).length == 0 || (mustMatch("specimenIdPlEd","scannedIdPlEd","The two barcode IDs must match") && entryNotEmpty("scannedIdPlEd","Scanned ID of Cryovial when transferred") && dateValid("bloodFrozenEd","Time Placed on Dry Ice") && dateValid("bloodStorageEd","Time Transferred to Freezer") && dateOrder("bloodFrozenEd","Time Placed on Dry Ice","bloodStorageEd","Time Transferred to Freezer") && entryNotEmpty("freezerTypeEd","Freezer Type Transferred to"));
    ...
    $("#saveBtn4").click(function() {
        ...
        if (specimenIDEdVal == null) specimenIDEdVal = '';
            ...
            specimenIDEdVal = specimenIDEdVal.replace(/^\s+|\s+$/g,''); 
    ...
    $("#saveBtn9").click(function(){
        if (entryNotEmpty("specimenIdWcp","Whole Cell Pellet aliquot Specimen barcode ID") && volValid('volumeWcp')) {
            $( "#specimenIdWcp" ).select();
            showWait("Adding specimen");
        } else {
            return false;
        }
    ...
    $("#saveBtn10").click(function(){
        if (volValid('volumeWcpEd')) {
            $( "#edit-wcp" ).dialog( "close" );
        } else {
            return false;
        }        
    });
    ...
    $("#cancelButton9").click(function(){
        $( "#add-wcp" ).dialog( "close" );
        return false;
    });

    $("#cancelButton10").click(function(){
        $( "#edit-wcp" ).dialog( "close" );
        return false;
    });
    ...
    $("#saveBtn1").click(function() {
        ...
        if (specimenIDVal == null) specimenIDVal = '';
            ...
            specimenIDVal = specimenIDVal.replace(/^\s+|\s+$/g,''); 
...
function editPlasma(id, specimenId, volume, timeDryIce, timeFreezer, freezerType) {
    $( "#edit-plasma" ).dialog( "open" );
    $( "#specimenIdPlEd" ).val(specimenId);
    $( "#specPlId" ).val(specimenId);
    $( "#volumePlEd" ).val(volume);
    $( "#bloodFrozenEd" ).datetimepicker("setDate", new Date(timeDryIce));
    $('.ui-datepicker-current-day').click(); 
    $("#specPlasmaId").val(id);
    
    //reset
    $("#scannedIdPlEd").val("");
    $("#bloodStorageEd").val("Select Date");
    $("#freezerTypeEd").val("");
    
    if (timeFreezer.length > 0 && freezerType.length > 0) {
        $("#scannedIdPlEd").val(specimenId);
        $("#bloodStorageEd").datetimepicker("setDate", new Date(timeFreezer));
        $('.ui-datepicker-current-day').click(); 
        $("#freezerTypeEd").val(freezerType);
    }
    $( "#coniTbCdEd" ).val($("#conTbId").html());
    return false;
}
...
function editWcp(id, specimenId, volume) {
    $( "#edit-wcp" ).dialog( "open" );
    $( "#specimenIdWcpEd" ).val(specimenId);
    $( "#specWcpId" ).val(specimenId);
    $( "#volumeWcpEd" ).val(volume);
    $("#specWCId").val(id)
    return false;
}
...
function dateValid(elemId,elemLabel) {
    if($("#"+elemId).val() == "Select Date"){
        alert("Enter Date for: " + elemLabel);
        $("#"+elemId).focus();
        return false;
    } else if(new Date($("#"+(elemId)).val()) > new Date()) {
        alert("Date & Time cannot be in the future for: " + elemLabel);
        $("#"+elemId).focus();
        return false;        
    } else {
        return true;
...
function dateOrder(elemId1,elemLabel1,elemId2,elemLabel2) {
 if(new Date($("#"+(elemId1)).val()) > new Date($("#"+(elemId2)).val())) {
        alert(elemLabel2+" cannot precede " + elemLabel1);
        $("#"+elemId2).focus();
        return false;        
    } else {
        return true;
...
function entryNotEmpty(elemId,elemLabel) {
    if($.trim($("#"+elemId).val()).length == 0){
        alert("Enter " + elemLabel);
        $("#"+elemId).focus();
        return false;
    } else {
        return true;
...
function mustMatch(elemId1,elemId2,elemLabel) {
    if($.trim($("#"+elemId1).val()) != $.trim($("#"+elemId2).val())){
        alert(elemLabel);
        $("#"+elemId2).focus();
        return false;
    } else {
...
function clearData (tissueType){
    var tissueId 
    if(tissueType.toLowerCase() === "centrifuge") {
        tissueId = "plasma";
    } else {
        tissueId = tissueType.replace("rna","rnaPax").replace("dna","dnaPax");
    }
    if($("#plasmaParBarCodeSelect").val().length == 0){
        $("#" + tissueId + "ParBarCode").val("");
    }
    $("#" + tissueId + "Frozen_cleardate").trigger("click");
    $("#" + tissueId + "Storage_cleardate").trigger("click");
    $("#" + tissueId + "ProcFrozen_cleardate").trigger("click");
    $("#" + tissueId + "ProcStorage_cleardate").trigger("click");
    ...
    if( tissueType.toLowerCase() === "plasma" || tissueType.toLowerCase() === "centrifuge") {
        ...
        $("#plasmaTransferTech").val("");
        if( tissueType.toLowerCase() === "plasma" ) {
            clearData("wholeBlood");
        }
    } else if( tissueType.toLowerCase() === "wholeblood") {
        $("#plasmaRemainingVol").val("");
        $("#wholeBloodProcEnd_cleardate").trigger("click");
    }
}
...
function updateParBarCodeDisp(){
    for(var i=0; i < availableTissueTypes.length; i++){
        ...
        if(currentTissue != "serum"){
            ...
            $(".gen1-" + currentTissue ).each(function() { 
                ...
                if ( (currentTissue == "plasma") && currentVal == selectVal) { 
            ...
            $("#" + currentTissue + "ParBarCodeSelect").change(function() {
               ...
               $( "#parSrmBarCd").val($("#plasmaParBarCode").val()); 
               $( "#serumParBarcodeDisp").html($("#plasmaParBarCode").val());
            });
        }
        ...
        if(currentTissue != "plasma"){
            ...
            $("#wcpParBarcodeDisp").closest('td').addClass($("option:selected", $("#plasmaParBarCodeSelect")).attr("class"));
        }
    ...
    $("#dnaParBarCodeSelect").change(function() {
        if (($("#dnaPaxProcTech").val() + $("#dnaPaxProcComments").val() + $("#dnaPaxStorageIssues").val() + $("#dnaPaxFrozen_day").val() + $("#dnaPaxStorage_day").val()).length > 0 || $("input[name='dnaPaxProcSopDev']:checked").val() == "No") {
    ...
    $("#rnaParBarCodeSelect").change(function() {
        if (($("#rnaPaxProcTech").val() + $("#rnaPaxProcComments").val() + $("#rnaPaxStorageIssues").val() + $("#rnaPaxFrozen_day").val() + $("#rnaPaxStorage_day").val()).length > 0 || $("input[name='rnaPaxProcSopDev']:checked").val() == "No") {
            currentSpecSelect = "rna";
            $("#dialog-confirm").dialog("open");
        }   
    });

    $("#plasmaParBarCodeSelect").change(function() {
        var allPlasmaEntriesNotEmpty = ($("#plasmaProcStart_day").val() + $("#plasmaProcTech").val() + $("#plasmaTransferTech").val() + $("#plasmaStorageIssues").val()).length > 0 || $("input:radio[name='plasmaProcSopDev']").is(":checked") || $("input:radio[name='plasmaHemolysis']").is(":checked");
        var allWholeCellEntriesNotEmpty = ($("#plasmaRemainingVol").val() + $("#wholeBloodProcEnd_day").val() + $("#wholeBloodProcFrozen_day").val() + $("#wholeBloodProcStorage_day").val() + $("#wholeBloodProcTech").val() + $("#wholeBloodProcComments").val() + $("#wholeBloodStorageIssues").val()).length > 0 || $("input:radio[name='wholeBloodProcSopDev']").is(":checked");
        if ($("#pageloadplasmaParBarCode").val().length > 0 && (allPlasmaEntriesNotEmpty || allWholeCellEntriesNotEmpty)) {
            currentSpecSelect = "plasma";
            if($(this).val().length == 0){
                $(".ui-dialog .ui-dialog-buttonset .ui-button:nth-of-type(1)").hide();
            } else {
                $(".ui-dialog .ui-dialog-buttonset .ui-button:nth-of-type(1)").show();
            }
            $("#dialog-confirm").dialog("open");
        } else {
            showWait("Updating Form");
