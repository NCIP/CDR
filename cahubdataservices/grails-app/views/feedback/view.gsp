...
<html>
    ...
    <body>
      ...
      <div id="container" class="clearfix">
            <h1 align="Center" style="font-weight: bold;">Procurement Feedback For ${feedbackInstance.caseRecord.caseId}</h1>
            ...
            <g:form method="post" enctype="multipart/form-data" >
                ...
                <div class="list">
                 ...
                 <table>
                   <tbody>
               <tr class="prop">
                <td><label>Case ID:</label> <g:link controller="caseRecord" action="display" id="${feedbackInstance.caseRecord.id}">${feedbackInstance.caseRecord.caseId}</g:link></td>
                <td><label>Collection Type:</label> ${feedbackInstance.caseRecord.caseCollectionType}</td>       
               <td><label>BSS:</label> ${feedbackInstance.caseRecord.bss.name}</td>
               </tr>  
              </tbody>
             </table>
                  ...
                  <table>
                   ...
                   <table>
                     <tr>
                       <td> ${feedbackInstance?.comments}</td>
                     </tr>
                   </table>
                  ...
                  <table>
                    ...
                    <tr>
                      <td>${feedbackInstance.reviewedBy}</td>
                    <g:if test="${feedbackInstance.reviewDate}">
                      <td><g:formatDate format="MM/dd/yyyy" date="${feedbackInstance.reviewDate}"/></td>
                    ...
                    <g:else>
                      <td>Not reviewed yet.</td>
                        ...
                        <g:if test="${feedbackInstance.status == 'Submitted'}">
                   <g:if test="${session.authorities.contains('ROLE_NCI-FREDERICK_CAHUB_PRC') || session.getAttribute('PRC')}">
                      <div class="buttons">
                        ...
                        <span class="button"><g:actionSubmit class="save" action="startnew" value="Start Next Version"  onclick="return confirm('Are you sure you want to create a new version of the Procurement Feedback?')" /></span>
