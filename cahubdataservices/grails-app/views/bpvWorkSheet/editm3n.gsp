...
<html>
  ...
  <g:javascript>
    ...
    type:'POST',
    dataType: "text", 
    data: ({value:this.value, field:this.name, now:now_str, t1:t1, t2:t2, t3:t3, t4:t4, module:'3n', mid:mid, side:side}),
    ...
    type:'POST',
    dataType: "text", 
    data: ({value:this.value, field:this.name,  t1:t1, t2:t2, t3:t3, t4:t4, module:'3n', mid:mid, side:side}),
...
<body>
      <div id="nav" class="clearfix">
          <div id="navlist">
            ...
            <g:link class="edit" action="edit" id="${module3NSheetInstance.bpvWorkSheet.id}">FFPE Worksheet Main</g:link>
        </div>
      </div>
      <div id="container" class="clearfix">
    <h1>Edit Module III Of Tissue Processing Worksheet</h1>
    <g:if test="${flash.message}">
      <div class="message">${flash.message}</div>
    </g:if>
    <g:hasErrors bean="${module3NSheetInstance}">
      <div class="errors">
        <g:renderErrors bean="${module3NSheetInstance}" as="list" />
      </div>
    </g:hasErrors>
   ...
   <g:render template="/caseRecord/caseDetails" bean="${bpvWorkSheetInstance.caseRecord}" var="caseRecord" /> 
    <br></br>
    <g:form method="post" >
      <g:hiddenField id="mid" name="id" value="${module3NSheetInstance?.id}" />
      <g:hiddenField name="version" value="${module3NSheetInstance?.version}" />
     
      <table>
         <tr><td class="name">Select Priority<span id="bpvworksheet.priority" class="vocab-tooltip"></span></td><td class="value ${hasErrors(bean: module3NSheetInstance, field: 'priority', 'errors')}"><div><g:radio id ="p1" name="priority"  value="1" checked="${module3NSheetInstance.priority ==1}"  />&nbsp;<label for="p1">Priority I</label><br /><g:radio id ="p2" name="priority"  value="2" checked="${module3NSheetInstance.priority ==2}"  />&nbsp;<label for="p2">Priority II</label></div></td></tr>
       </table>
      <br></br>
      
      <g:if test ="${bpvWorkSheetInstance.caseRecord.primaryTissueType.code=='OVARY'}">
       <table>
         <tr><td class="name">Module III tissue was collected from:<span id="bpvworksheet.moduletissuefrom" class="vocab-tooltip"></span></td><td class="value ${hasErrors(bean: module3NSheetInstance, field: 'whichOvary', 'errors')}"><div><g:radio id ="l" name="whichOvary"  value="L" checked="${module3NSheetInstance.whichOvary =='L'}"  />&nbsp;<label for="l">Left Ovary</label><br /><g:radio id ="r" name="whichOvary"  value="R" checked="${module3NSheetInstance.whichOvary =='R'}"  />&nbsp;<label for="r">Right Ovary</label></div></td></tr>
       </table>
      </g:if>
      ...
      <div class="line">
         ...
         <table class="bpvws">
          <tbody>
            <tr><th colspan="2" > Frozen Control Tissue Sample Information, Module III</th></tr>
            <tr class="prop" >
              ...
              <td class='${errorMap.get("sampleId4Frozen_" +module3NSheetInstance?.sampleFr?.id)} ${warningMap.get("sampleId_" +module3NSheetInstance?.sampleFr?.id)? "warnings" : ""}'><g:textField class="recorddate" name="sampleId4Frozen_${module3NSheetInstance?.sampleFr?.id}" value="${module3NSheetInstance?.sampleFr?.sampleId4Frozen}" /></td>
          </tr>
          <tr class="prop">
            ...
            <td class="${errorMap.get("dateSampleFrozenStr_" +module3NSheetInstance?.sampleFr?.id)}"><g:textField  name="dateSampleFrozenStr_${module3NSheetInstance?.sampleFr?.id}" value="${module3NSheetInstance?.sampleFr?.dateSampleFrozenStr}" /> </td>
          </tr>
          ...
          <tr class="prop">
            ...
            <td valign="top" class="value ${errorMap.get("weight_" +module3NSheetInstance?.sampleFr?.id)}">
          <g:textField class="weight" id="sampleFrWeight" name="weight_${module3NSheetInstance?.sampleFr?.id}" value="${module3NSheetInstance?.sampleFr?.weight}" /> mg
          </td>
          </tr>
        ...
        <br></br>
      <table class="bpvws">
        <tr><th colspan="7" class="bpvws">Module III: QC FFPE Section</th></tr>
        <tr>
          <th>Protocol</th>
        ...
        <g:each in="[module3NSheetInstance.sampleQc]" status="i" var="s">
          <tr id="${s.protocolId}">
            <td>${s.protocol}</td>
      ...
      <table class="bpvws">
        <tr><th colspan="10" class="bpvws">Module III: QC FFPE Section<br />Continue entering data for QC FFPE Section</th></tr>
        <tr>
          <th>Protocol</th>
      ...
      <br></br>
      <table class="bpvws">
        <tr><th colspan="8" class="bpvws">Module III:</th></tr>
        <tr>
         ...
         <g:each in="[module3NSheetInstance.sampleI, module3NSheetInstance.sampleJ, module3NSheetInstance.sampleK, module3NSheetInstance.sampleL, module3NSheetInstance.sampleM, module3NSheetInstance.sampleN]" status="i" var="s">
      ...
      <div class="buttons">
        <span class="button"><g:actionSubmit id="sub" class="save" action="updatem3n" value="Save" /></span>
      </div>
    </g:form>
  </div>
</body>
