    ...
    <body>
      ...
      <div id="container" class="clearfix">
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${caseDwInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="specimens"><g:message code="caseDw.specimens.label" default="Specimens" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: caseDwInstance, field: 'specimens', 'errors')}">
