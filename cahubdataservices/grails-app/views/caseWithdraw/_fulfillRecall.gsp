...
<div class="list">
  <table>
    ...
    <tr class="prop">
      <td colspan="2" class="name ${hasErrors(bean: caseWithdrawInstance, field: 'finalAnyOtherNotified', 'errors')}">
        <label for="finalAnyOtherNotified">Other entities notified: </label><br />
    <g:textArea class="textwide" name="finalAnyOtherNotified" cols="40" rows="5" value="${caseWithdrawInstance?.finalAnyOtherNotified}" />
    </td>
    </tr>
