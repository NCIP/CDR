                                    ...
                                    <tr class="prop">
                                        <td colspan="2" class="name" >
                                            ...
                                            <g:if test="${bpvLocalPathReviewInstance?.organOrigin == 'Other'}">
                                                <span id="oo" style="display: block" class="value"><br/>Specify other organ of origin: <g:textField id="otherOrganOrigin" name="otherOrganOrigin" value="${bpvLocalPathReviewInstance?.otherOrganOrigin}" /></span>  
                                            </g:if>
                                            <g:else>
                                                <span id="oo" style="display: none"  class="value"><br/>Specify other organ of origin: <g:textField id="otherOrganOrigin" name="otherOrganOrigin" value="${bpvLocalPathReviewInstance?.otherOrganOrigin}" /></span>  
                                            </g:else>
                                        </td>
                                    </tr>
                                    ...
                                    <td class="name" colspan="2">
                                            ...
                                            <div class="subentry value histologictype">
                                                <g:each in="${hisList}" status="i" var="his">
                                                    ...
                                                    <g:if test="${(his.code == 'C7' || his.code == 'C8' || his.code == 'C9' || his.code == 'C78') && bpvLocalPathReviewInstance.histologicType?.id == his.id}">
                                                        <span><br/>Specify types and %:<br/><g:textArea name="otherHistologicType" cols="40" rows="5" value="${bpvLocalPathReviewInstance.otherHistologicType}" /><br/><br/></span>
                                                    </g:if>
                                                    <g:if test="${(his.code == 'C20' || his.code == 'OTHER') && bpvLocalPathReviewInstance.histologicType?.id == his.id}">
                                                        <span><br/>Specify type:<br/><g:textArea name="otherHistologicType" cols="40" rows="5" value="${bpvLocalPathReviewInstance.otherHistologicType}" /><br/><br/></span>
                                                    </g:if>
                                                </g:each>
                                            </div>
                                        </td>
                                        ...
                                        <tr class="prop subentry">
                                            <td colspan="2" class="name" >
                                                <g:if test="${bpvLocalPathReviewInstance?.sarcomatoid == 'Present'}">
                                                    <span id="sad" style="display: block" class="value"><br/>Describe Sarcomatoid features: <br/><g:textArea id="sarcomatoidDesc" name="sarcomatoidDesc" cols="40" rows="5" value="${bpvLocalPathReviewInstance?.sarcomatoidDesc}" /></span>  
                                                </g:if>
                                                <g:else>
                                                    <span id="sad" style="display: none"  class="value"><br/>Describe Sarcomatoid features: <br/><g:textArea id="sarcomatoidDesc" name="sarcomatoidDesc" cols="40" rows="5" value="${bpvLocalPathReviewInstance?.sarcomatoidDesc}" /></span>  
                                                </g:else>
                                            </td>
                                        </tr>
                                    </g:if>
                                    ...
                                    <tr class="prop">
                                        ...
                                        <td class="value" ><g:textField id="tumorDimension" name="tumorDimension" value="${fieldValue(bean: bpvLocalPathReviewInstance, field: 'tumorDimension')}" /> (mm)</td>
                                    </tr>  
                                    ...
                                    <tr class="prop">
                                        ...
                                        <td class="value" ><g:textField id="pctTumorArea" name="pctTumorArea" value="${fieldValue(bean: bpvLocalPathReviewInstance, field: 'pctTumorArea')}" /> %</td>
                                    </tr>
                                    ...
                                    <tr class="prop">
                                        ...
                                        <td class="value" ><g:textField id="pctTumorCellularity" name="pctTumorCellularity" value="${fieldValue(bean: bpvLocalPathReviewInstance, field: 'pctTumorCellularity')}" /> %</td>
                                    </tr>
                                    ...
                                    <tr class="prop clearborder">
                                        <td class="name" colspan="2">
                                            ...
                                            <span data-msg="If present, describe Non-Cellular Component" class="cahub-tooltip"></span>
                                        </td>                                
                                    </tr>
                                        ...
                                        <td class="name" colspan="2">
                                            <table class="tabledatecomments">
                                                <tr>
                                                    ...
                                                    <td class="value" style=" width:25%"><g:textField id="p1" name="pctViablTumor" value="${fieldValue(bean: bpvLocalPathReviewInstance, field: 'pctViablTumor')}" SIZE="10" /> %</td>
                                                </tr>
                                                <tr>
                                                    <td >Percent Necrotic Tumor by surface area</td>
                                                    <td class="value" ><g:textField id="p2" name="pctNecroticTumor" value="${fieldValue(bean: bpvLocalPathReviewInstance, field: 'pctNecroticTumor')}" SIZE="10" /> %</td>
                                                </tr> 
                                                <tr>
                                                    <td >Percent Viable Non-Tumor Tissue by surface area</td>
                                                    <td class="value" ><g:textField id="p3" name="pctViableNonTumor" value="${fieldValue(bean: bpvLocalPathReviewInstance, field: 'pctViableNonTumor')}" SIZE="10" /> %</td>
                                                </tr>
                                                <tr>
                                                    <td>Percent Non-Cellular Component by surface area (i.e., mucin, hemorrhage, blood clot, etc.)</td>
                                                    <td class="value"><g:textField id="p4" name="pctNonCellular" value="${fieldValue(bean: bpvLocalPathReviewInstance, field: 'pctNonCellular')}"  SIZE="10" /> %</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="formheader"><g:textField id="t" name="hisTotal" value="${fieldValue(bean: bpvLocalPathReviewInstance, field: 'hisTotal')}" SIZE="10" /> %</td>
                                                </tr> 
                                            </table>
                                        </td> 
                                    </tr>
                                        ...
                                        <tr class="prop" id="who" style="display:${bpvLocalPathReviewInstance?.gradingSystem == 'WHO Grading System' ? 'display' : 'none'}">
                                            ...
                                            <td class="value" >
                                                <div>
                                                    ...
                                                    <g:radio name="grade" id='w5' value="GX: Cannot be assessed" checked="${bpvLocalPathReviewInstance?.grade =='GX: Cannot be assessed'}"/>&nbsp;<label for="w5">GX: Cannot be assessed</label>
                                                </div>
                                            </td>
                                        </tr>
