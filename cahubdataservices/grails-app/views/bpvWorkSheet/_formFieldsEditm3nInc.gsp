      ...
      <div class="line">
         ...
         <table class="bpvws">
          ...
          <tr class="prop">
            ...
            <td class="${errorMap.get("dateSampleFrozenStr_" +module3NSheetInstance?.sampleFr?.id)}">
            
              <g:if test="${session.LDS == true}">
          <g:textField  name="dateSampleFrozenStr_${module3NSheetInstance?.sampleFr?.id}" value="${module3NSheetInstance?.sampleFr?.dateSampleFrozenStr}" />
           </g:if>
      ...
      <table class="bpvws">
        ...
        <g:each in="[module3NSheetInstance.sampleQc]" status="i" var="s">
          <tr id="${s.protocolId}">
            ...
            <td class='${errorMap.get("sampleId4Record_" +s.id)} ${warningMap.get("sampleId_" +s.id)? "warnings" : ""}'>  
          <g:textField class="recorddate" name="sampleId4Record_${s.id}" value="${s.sampleId4Record}" size="15" />
          </td>
          ...
          <td class="${warningMap?.get('interval1_' + s.id) ? 'warnings' : ''}"><span id="in1_${s.id}">${intervalMap3n.get('interval1_' + s.id)}</span></td>
          </tr>
        </g:each>
      </table>
      <br></br>
      ...
      <table class="bpvws">
        ...
        <g:each in="[module3NSheetInstance.sampleQc]" status="i" var="s">
         ...
         <g:if test="${session.LDS == false || session.LDS == null}">
          ...
          <td class="${warningMap?.get('interval2_' + s.id) ? 'warnings' : ''}"><span id="in2_${s.id}">${intervalMap3n.get('interval2_' + s.id)}</span></td>
          ...
          <td><span id="in3_${s.id}">${intervalMap3n.get('interval3_' + s.id)}</span></td>
