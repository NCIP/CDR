...
<g:set var="bodyclass" value="brnhome home wide" scope="request"/>
    ...
    <body>   
       <div id="nav" class="clearfix">
          <div id="navlist">
            ...
            <g:if test="${session.authorities.contains('ROLE_NCI-FREDERICK_CAHUB_SUPER') || session.authorities.contains('ROLE_ADMIN')}">
                <g:link controller="backoffice" class="list menuButton" action="index">Back Office</g:link>
      ...
      <div id="container" class="clearfix">
            ...
            <div class="list">
              ...
              <g:render template="/caseRecord/caseRecordBrnTable_tmpl" bean="${caseRecordList}" />
