            ...
            <g:form method="post" enctype="multipart/form-data" >
                ...
                <div class="list">
                  ...
                  <table>
                   ...
                   <table>
                    ...
                    <g:each in="${feedbackIssueList}" status="i" var="fi">
                      ...
                      <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                        ...
                        <g:if test="${feedbackInstance.currentSubmission.feedbackVersion > fi.submissionCreated.feedbackVersion}">
                   ...
                   <table>
                     <tr>
                       <td>   <g:textArea name="comments" cols="120" rows="5" value="${feedbackInstance?.comments}" /></td>
                     </tr>
                   </table>
