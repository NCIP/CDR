...
<html>
  ...
  <g:set var="entityName" value="${message(code: 'module5Sheet.label', default: 'Module5Sheet')}" />
  ...
  <g:javascript>
    ...
    type:'POST',
    dataType: "text", 
    data: ({value:this.value, field:this.name, now:now_str, t1:t1, t2:t2, t3:t3, t4:t4, module:'5', mid:mid, side:side}),
    ...
    type:'POST',
    dataType: "text", 
    data: ({value:this.value, field:this.name,  t1:t1, t2:t2, t3:t3, t4:t4, module:'5', mid:mid, side:side}),
...
<body>
      <div id="nav" class="clearfix">
          <div id="navlist">
            ...
            <g:link class="edit" action="edit" id="${module5SheetInstance.bpvWorkSheet.id}">FFPE Worksheet Main</g:link>
        </div>
      </div>
      <div id="container" class="clearfix">
    <h1>Edit Module V Of Tissue Processing Worksheet</h1>
    <g:if test="${flash.message}">
      <div class="message">${flash.message}</div>
    </g:if>
    <g:hasErrors bean="${module5SheetInstance}">
      <div class="errors">
        <g:renderErrors bean="${module5SheetInstance}" as="list" />
      </div>
    </g:hasErrors>
   ...
   <g:render template="/caseRecord/caseDetails" bean="${bpvWorkSheetInstance.caseRecord}" var="caseRecord" /> 
    <br></br>
    <g:form method="post" >
      <g:hiddenField id="mid" name="id" value="${module5SheetInstance?.id}" />
      <g:hiddenField name="version" value="${module5SheetInstance?.version}" />
     
      <table>
         <tr><td class="name">Select Priority<span id="bpvworksheet.priority" class="vocab-tooltip"></span></td><td class="value ${hasErrors(bean: module5SheetInstance, field: 'priority', 'errors')}"><div><g:radio id ="p1" name="priority"  value="1" checked="${module5SheetInstance.priority ==1}"  />&nbsp;<label for="p1">Priority I</label><br /><g:radio id ="p2" name="priority"  value="2" checked="${module5SheetInstance.priority ==2}"  />&nbsp;<label for="p2">Priority II</label></div></td></tr>
       </table>
      <br></br>
      
      <g:if test ="${bpvWorkSheetInstance.caseRecord.primaryTissueType.code=='OVARY'}">
       <table>
         <tr><td class="name">Module V tissue was collected from:<span id="bpvworksheet.moduletissuefrom" class="vocab-tooltip"></span></td><td class="value ${hasErrors(bean: module5SheetInstance, field: 'whichOvary', 'errors')}"><div><g:radio id ="l" name="whichOvary"  value="L" checked="${module5SheetInstance.whichOvary =='L'}"  />&nbsp;<label for="l">Left Ovary</label><br /><g:radio id ="r" name="whichOvary"  value="R" checked="${module5SheetInstance.whichOvary =='R'}"  />&nbsp;<label for="r">Right Ovary</label></div></td></tr>
       </table>
      </g:if>
      ...
      <div class="line">
         ...
         <table class="bpvws">
          ...
          <tr class="prop">
            ...
            <td class="${errorMap.get("dateSampleFrozenStr_" +module5SheetInstance?.sampleFr?.id)}"><g:textField  name="dateSampleFrozenStr_${module5SheetInstance?.sampleFr?.id}" value="${module5SheetInstance?.sampleFr?.dateSampleFrozenStr}" /> </td>
          </tr>
      ...
      <div class="buttons">
        <span class="button"><g:actionSubmit id="sub" class="save" action="updatem5" value="Save" /></span>
      </div>
    </g:form>
  </div>
</body>
